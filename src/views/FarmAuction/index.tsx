        ...
        <Flex flexDirection={['column-reverse', 'row']}>
          <Left>
            ...
            <Text bold fontSize="16px" color="textSubtle" mb="24px">
              {t('Each week, qualifying projects can bid SCC for the right to host a 7-day Farm.')}
            </Text>
            <Link external href='https://t.me/SiaCashCoinChat'>
              <Button>
          ...
          <Right>
            <img src="/images/scc.svg" alt="SCC Auction" />
          </Right>
        </Flex>
      </StyledHeader>
      <>
