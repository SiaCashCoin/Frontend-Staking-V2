    ...
    <Flex flexDirection="column">
      ...
      <>
        {prizeInBusd.isNaN() ? (
          ...
          <Balance fontSize="20px" bold unit=" SCC" value={getBalanceNumber(cakeAmount)} decimals={0} />
        )}
        {prizeInBusd.isNaN() ? (
          ...
          <>
            {numberWinners !== '0' && (
              <Text fontSize="12px" color="textSubtle">
                {getFullDisplayBalance(cakeAmount.div(parseInt(numberWinners, 10)), 18, 2)} SCC {t('each')}
              </Text>
            )}
            <Text fontSize="12px" color="textSubtle">
